...
SWIFT_CLASS("_TtC10WeatherApp26ForecastCollectionViewCell")
...
SWIFT_CLASS("_TtC10WeatherApp20WeatherTableViewCell")
@interface WeatherTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified weatherDaysLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified tempLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified weatherImageView;
- (void)awakeFromNib;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified weatherInfoLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified tempLabel;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified botContainer;
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified hourlyWeather;
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified weatherInfo;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified weeklyWeatherTable;
@property (nonatomic, weak) IBOutlet UIScrollView * _Null_unspecified scrollView;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
...
@interface WeatherView (SWIFT_EXTENSION(WeatherApp)) <UICollectionViewDataSource>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface WeatherView (SWIFT_EXTENSION(WeatherApp)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC10WeatherApp29weatherInfoCollectionViewCell")
@interface weatherInfoCollectionViewCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified infoTopLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified infoImageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified infoBottomLabel;
- (void)awakeFromNib;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
